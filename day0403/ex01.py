...
print('*'*20)
# 예제 9. 2차원 배열을 다시 1차원 배열으로
# => 내가 직접 데이터의 수를 파악하기 보다는 shape를 통해 행,열 만큼의 배열을 생성
a = np.array([[1,2,3],[4,5,6]])
...
# 방법3. size -> 배열의 요소의 수를 알 수 있다.
print(a.size) # 결과 : 6
d = a.reshape(a.size)
print(d)

# 방법4. 1차원으로 알아서 바꿔달라고 -1을 사용
e = a.reshape(-1)
print(e)
